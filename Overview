...
This graph depicts of a simplified lifecycle of the AUP.  
...
1. [Inception](https://github.com/nopara73/ForeverAloneProgramming/wiki/1.-Inception): The goal is to identify the initial scope of the project.
2. [Elaboration](https://github.com/nopara73/ForeverAloneProgramming/wiki/2.-Elaboration): The goal is to ensure that the team can actually develop a system that satisfies the requirements.
3. [Construction](https://github.com/nopara73/ForeverAloneProgramming/wiki/3.-Construction): The goal is to build working software.
4. [Transition](https://github.com/nopara73/ForeverAloneProgramming/wiki/4.-Transition): The goal is to validate and deploy your system into your production environment.
